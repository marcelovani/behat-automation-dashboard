    ...
    return [
      '#markup' => '<h1>Automation Dashboard</h1>
                    ...
                    <div id="legend">
                      ...
                      <ul>
                        <li class="yellow">
                          <img src="/modules/contrib/behat_automation_dashboard/images/yellow.png">
                          <span>Jobs that do not have any updates in the last hour</span>
                        </li>
                        <li class="wip">
                          <img src="/modules/contrib/behat_automation_dashboard/images/wip.png">
                          <span>Jobs currently running without failures so far</span>
                        </li>
                        <li class="green">
                          <img src="/modules/contrib/behat_automation_dashboard/images/green.png">
                          <span>All scenarios passed in the last hour</span>
                        </li>
                        <li class="red">
                          <img src="/modules/contrib/behat_automation_dashboard/images/red.png">
